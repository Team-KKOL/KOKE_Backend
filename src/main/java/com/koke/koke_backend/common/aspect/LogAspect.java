package com.koke.koke_backend.common.aspect;
...
public class LogAspect {
    ...
    @Pointcut("within(com.koke.koke_backend.*.repository..*)")
    public void jpaQuery() {
    }

    @Pointcut("within(com.koke.koke_backend.*.module..*)")
    public void module() {
    }

    @Pointcut("within(com.koke.koke_backend.*.module.json..*)")
    ...
    @Around("@annotation(com.koke.koke_backend.common.aspect.LogExecutionTime) || restApi() || jpaQuery() || module() && !jsonModule()")
